export interface ObitMsgCreateTaResponse {
    /** @format uint64 */
    id?: string;
}
export declare type ObitMsgDeleteTaResponse = object;
export interface ObitMsgMintObitResponse {
    did?: string;
}
/**
 * MsgSendResponse defines the Msg/Send response type.
 */
export declare type ObitMsgSendResponse = object;
 ...
 */
export interface ObitQueryParamsResponse {
    /** params holds all the parameters of this module. */
    params?: ObitParams;
}
export interface ObitTa {
    /** @format uint64 */
    id?: string;
    title?: string;
    pubkey?: string;
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    ...
    }, params?: RequestParams) => Promise<HttpResponse<ObitQueryAllTaResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
