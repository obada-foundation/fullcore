...
var (
	_ runtime.AppI            = (*NodeApp)(nil)
	_ servertypes.Application = (*NodeApp)(nil)
)

// NodeApp extends an ABCI application, but with most of its parameters exported.
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".fullcored")
}
...
func (app *NodeApp) kvStoreKeys() map[string]*storetypes.KVStoreKey {
