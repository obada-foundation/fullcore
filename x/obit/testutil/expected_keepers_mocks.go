...
// Source: x/obit/types/expected_keepers.go
...
func (m *MockNftKeeper) BatchMint(ctx context.Context, tokens []nft.NFT, receiver types.AccAddress) error {
	m.ctrl.T.Helper()
...
func (m *MockNftKeeper) BatchTransfer(ctx context.Context, classID string, nftIDs []string, receiver types.AccAddress) error {
	m.ctrl.T.Helper()
...
func (m *MockNftKeeper) BatchUpdate(ctx context.Context, tokens []nft.NFT) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BatchUpdate", ctx, tokens)
	ret0, _ := ret[0].(error)
	return ret0
}

// BatchUpdate indicates an expected call of BatchUpdate.
func (mr *MockNftKeeperMockRecorder) BatchUpdate(ctx, tokens interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BatchUpdate", reflect.TypeOf((*MockNftKeeper)(nil).BatchUpdate), ctx, tokens)
}

// GetClasses mocks base method.
func (m *MockNftKeeper) GetClasses(ctx context.Context) []*nft.Class {
	m.ctrl.T.Helper()
...
func (m *MockNftKeeper) GetNFTsOfClassByOwner(ctx context.Context, classID string, owner types.AccAddress) []nft.NFT {
	m.ctrl.T.Helper()
...
func (m *MockNftKeeper) GetOwner(ctx context.Context, classID, nftID string) types.AccAddress {
	m.ctrl.T.Helper()
...
func (m *MockNftKeeper) HasClass(ctx context.Context, classID string) bool {
	m.ctrl.T.Helper()
...
func (m *MockNftKeeper) Mint(ctx context.Context, token nft.NFT, receiver types.AccAddress) error {
	m.ctrl.T.Helper()
...
func (m *MockNftKeeper) Transfer(ctx context.Context, classID, nftID string, receiver types.AccAddress) error {
	m.ctrl.T.Helper()
...
func (m *MockNftKeeper) Update(ctx context.Context, token nft.NFT) error {
	m.ctrl.T.Helper()
